...
public class MenuManager : MonoBehaviour
{
    ...
    private void SetupStats()
    {
        ...
        beginnerTime.text = "Novato: " + PlayerPrefs.GetInt("MinesweeperBestBeginnerTime").ToString();
        standardTime.text = "Normal: " + PlayerPrefs.GetInt("MinesweeperBestStandardTime").ToString();
        advancedTime.text = "Viciado: " + PlayerPrefs.GetInt("MinesweeperBestAdvancedTime").ToString();
    }
